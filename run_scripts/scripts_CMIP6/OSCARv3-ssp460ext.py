...
out_init = xr.open_dataset('results/'+folder+'/ssp460_Out-'+str(setMC)+'.nc' )
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'ssp460ext':
## - Concentrations for CO2, CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP4-6.0-ext
## *********************************************************
...
for_runs_scen = xr.open_dataset('results/'+folder+'/ssp460_For-'+str(setMC)+'.nc')
