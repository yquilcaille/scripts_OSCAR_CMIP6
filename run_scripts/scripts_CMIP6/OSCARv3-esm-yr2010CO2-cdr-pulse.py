...
name_experiment = 'esm-yr2010CO2-cdr-pulse'
year_PI = 1850
year_start = 1850
year_end = 2010+1000
nMC = 1000
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'esm-yr2010CO2-cdr-pulse':
## - Concentrations of CH4, N2O and halo are still driven using 'concentrations_CMIP6'
## - Emissions
##      - CO2 from compatible emissions from the experiment 'yr2010CO2'. In 2015, 100 GtC is removed from the atmosphere.
...
## compatible emissions, with a 100 GtC removal in 2015.
...
For['Eff'].loc[{'reg_land':0,'year':2015}] -= 100.
