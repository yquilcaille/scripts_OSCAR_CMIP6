...
name_experiment = 'esm-ssp585-ssp126Lu'
year_PI = 1850
year_start = 2014
year_end = 2100
nMC = 1000
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'esm-ssp585-ssp126Lu':
## - Concentrations for CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP5-8.5
## - Emissions for all from 'emissions_ScenarioMIP', SSP5-8.5  (N2O, CH4 and Xhalo: not used, but here to allow the computation to run). Eff fall in this category.
