...
name_experiment = 'esm-bell-750PgC'
year_PI = 1850
year_start = 1850
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'esm-bell-750PgC':
## - Concentrations for CH4, N2O and halo from 'concentrations_CMIP6', year 1850
## - Emissions of CO2 from 'extra_data/ZECMIP_data/ZEC-MIP_Bellcurve_750PgC.csv'
...
TMP = np.array( [line for line in csv.reader(open('extra_data/ZECMIP_data/ZEC-MIP_Bellcurve_750PgC.csv'))][5:] , dtype=np.float32)
