...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'abrupt-2xCO2':
## - Concentrations for CO2: value of 1850 multiplied by 2 in 1850, and held over time.
...
with xr.open_dataset('input_data/observations/concentrations_CMIP6.nc') as TMP:
    ...
    For['D_CO2'] = For['D_CO2'].fillna( 2. * TMP['CO2'].loc[{'year':year_PI,'region':'Globe'}] - Par['CO2_0'] )
    ## CH4 and N2O
    for var in ['CH4','N2O']:
