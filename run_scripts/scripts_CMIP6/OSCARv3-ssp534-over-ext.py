...
name_experiment = 'ssp534-over-ext'
...
out_init = xr.open_dataset('results/'+folder+'/ssp534-over_Out-'+str(setMC)+'.nc' )
...
for_runs_scen = xr.open_dataset('results/'+folder+'/ssp534-over_For-'+str(setMC)+'.nc')
