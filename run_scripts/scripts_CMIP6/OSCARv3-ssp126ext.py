...
out_init = xr.open_dataset('results/'+folder+'/ssp126_Out-'+str(setMC)+'.nc' )
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'ssp126ext':
## - Concentrations for CO2, CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP1-2.6-ext
## *********************************************************
...
for_runs_scen = xr.open_dataset('results/'+folder+'/ssp126_For-'+str(setMC)+'.nc')
