...
##################################################
## Forcings for 'ssp126':
## - Concentrations for CO2, CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP1-2.6
## - Emissions for all from 'emissions_ScenarioMIP', SSP1-2.6  (FF, N2O, CH4 and Xhalo: not used, but here to allow the computation to run)
