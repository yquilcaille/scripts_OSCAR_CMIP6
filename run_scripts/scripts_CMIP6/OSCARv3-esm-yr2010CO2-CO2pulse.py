...
name_experiment = 'esm-yr2010CO2-CO2pulse'
year_PI = 1850
year_start = 1850
year_end = 2010+1000
nMC = 1000
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'esm-yr2010CO2-CO2pulse':
## - Concentrations of CH4, N2O and halo are still driven using 'concentrations_CMIP6'
## - Emissions
##      - CO2 from compatible emissions from the experiment 'yr2010CO2'. In 2015, 100 GtC is added to the atmosphere.
...
## compatible emissions, with a 100 GtC addition in 2015.
