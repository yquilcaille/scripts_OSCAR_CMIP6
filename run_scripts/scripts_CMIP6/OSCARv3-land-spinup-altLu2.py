...
name_experiment = 'land-spinup-altLu2'
year_PI = 1850
year_start = 1850
year_end = 1850+1000
nMC = 500
...
## 3. DRIVERS / FORCINGS
##################################################
## Forcings for 'land-spinup-altLu2':
...
## - Land-use: LUH2 historical "LUH2-Low", fixed at 1850 values
...
For['d_Hwood'] = For['d_Hwood'].fillna( For0['d_Hwood'].loc[{'year':year_PI,'data_LULCC':'LUH2-Low'}] )
...
For['d_Ashift'] = For['d_Ashift'].fillna( For0['d_Ashift'].loc[{'year':year_PI,'data_LULCC':'LUH2-Low'}] )
...
For['Aland_0'] = For0.Aland.sel(year=year_PI,data_LULCC='LUH2-Low')
