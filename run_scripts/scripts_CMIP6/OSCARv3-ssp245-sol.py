...
out_init = xr.open_dataset('results/'+folder+'/hist-sol_Out-'+str(setMC)+'.nc' )
...
## - RF for solar as the ramp over 10 years from ssp245 using reference CMIP6
...
for_runs_hist = xr.open_dataset('results/'+folder+'/hist-sol_For-'+str(setMC)+'.nc' )
