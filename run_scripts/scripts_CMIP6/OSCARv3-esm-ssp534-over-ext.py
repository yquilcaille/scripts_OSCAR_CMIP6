...
name_experiment = 'esm-ssp534-over-ext'
...
## 3. INITIALIZATION
##################################################
## Using initialization from last year of ssp534-over
out_init = xr.open_dataset('results/'+folder+'/esm-ssp534-over_Out-'+str(setMC)+'.nc' )
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'esm-ssp534-over-ext':
...
for_runs_scen = xr.open_dataset('results/'+folder+'/esm-ssp534-over_For-'+str(setMC)+'.nc')
