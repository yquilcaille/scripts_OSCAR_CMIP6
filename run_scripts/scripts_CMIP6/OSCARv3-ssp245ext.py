...
out_init = xr.open_dataset('results/'+folder+'/ssp245_Out-'+str(setMC)+'.nc' )
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'ssp245ext':
## - Concentrations for CO2, CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP2-4.5-ext
## *********************************************************
...
for_runs_scen = xr.open_dataset('results/'+folder+'/ssp245_For-'+str(setMC)+'.nc')
