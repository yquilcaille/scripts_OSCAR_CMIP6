...
name_experiment = 'ssp370-lowNTCF'
year_PI = 1850
year_start = 2014
year_end = 2100
nMC = 1000
...
## - Concentrations for CO2, CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP3-7.0-LowNTCF
## - Emissions for all from 'emissions_ScenarioMIP', SSP3-7.0-LowNTCF  (FF, N2O, CH4 and Xhalo: not used, but here to allow the computation to run)
...
for var in ['E_BC','E_CO','E_NH3','E_VOC','E_NOX','E_OC','E_SO2'] + ['Eff','E_CH4','E_N2O']:
    For[var].loc[{'year':np.arange(year_start+1,year_end+1)}] = For0E[var].loc[{'year':np.arange(year_start+1,year_end+1),'scen_'+var:'SSP3-7.0-LowNTCF'}]
