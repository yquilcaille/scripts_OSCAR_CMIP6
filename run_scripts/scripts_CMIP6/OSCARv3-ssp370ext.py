...
out_init = xr.open_dataset('results/'+folder+'/ssp370_Out-'+str(setMC)+'.nc' )
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'ssp370ext':
## - Concentrations for CO2, CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP3-7.0-ext
## *********************************************************
...
for_runs_scen = xr.open_dataset('results/'+folder+'/ssp370_For-'+str(setMC)+'.nc')
