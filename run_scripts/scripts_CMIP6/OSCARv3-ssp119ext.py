...
out_init = xr.open_dataset('results/'+folder+'/ssp119_Out-'+str(setMC)+'.nc' )
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'ssp119ext':
## - Concentrations for CO2, CH4, N2O and halo: from 'concentrations_ScenarioMIP', SSP1-1.9-ext
## *********************************************************
...
for_runs_scen = xr.open_dataset('results/'+folder+'/ssp119_For-'+str(setMC)+'.nc')
