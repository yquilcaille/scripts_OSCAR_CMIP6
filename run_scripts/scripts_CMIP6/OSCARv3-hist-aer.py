...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'hist-aer':
## - Concentrations for CO2, CH4, N2O and halo from 'concentrations_CMIP6', year 1850
## - Emissions for all except GhG from 'emissions_CEDS' and 'emissions_ScenarioMIP', SSP2-4.5 over 2015-2020
...
for var in ['E_BC','E_CO','E_NH3','E_VOC','E_NOX','E_OC','E_SO2']:
    ...
    ## 1850-2014
    For[var].loc[{'year':np.arange(year_start,2014+1)}] = For0[var].loc[{'year':np.arange(year_start,2014+1),'data_'+var:'CEDS'}]
    ## 2015-2020
    For[var].loc[{'year':np.arange(2015,year_end+1)}] = For0E[var].loc[{'year':np.arange(2015,year_end+1),'scen_'+var:'SSP2-4.5'}]
