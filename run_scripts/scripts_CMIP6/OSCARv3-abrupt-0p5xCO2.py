...
name_experiment = 'abrupt-0p5xCO2'
year_PI = 1850
year_start = 1850
year_end = 1850+1000
nMC = 1000
...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'abrupt-0p5xCO2':
## - Concentrations for CO2: value of 1850 divided by 2 in 1850, and held over time.
...
with xr.open_dataset('input_data/observations/concentrations_CMIP6.nc') as TMP:
    ...
    For['D_CO2'] = For['D_CO2'].fillna( 0.5 * TMP['CO2'].loc[{'year':year_PI,'region':'Globe'}] - Par['CO2_0'] )
    ## CH4 and N2O
    for var in ['CH4','N2O']:
