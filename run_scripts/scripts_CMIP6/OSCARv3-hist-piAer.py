...
## 4. DRIVERS / FORCINGS
##################################################
## Forcings for 'hist-piAer':
## - Concentrations for CO2, CH4, N2O and halo from 'concentrations_CMIP6'
## - Emissions for BC, NH3, OC, SO2 from 'emissions_CEDS', fixed to their 1850 value
## - Emissions for NOX, CO, VOC from 'emissions_CEDS', varying
